                ...
                <div id="TextColumn" className="w-full max-w-md mx-auto md:max-w-none md:mx-0">
                    <div id= "TContent" className="md:w-6/12 mt-16 md:mt-0 ">
                        <div id="TContentLeft" className="md:mr-12 lg:mr-16 md:order-first">
                            <div id="subheading" className="text-center text-primary-500 md:text-left">About MetricQL</div>
                            <div id="heading" className="mt-4 font-black text-left text-3xl sm:text-4xl lg:text-5xl text-blue-900 text-center md:text-left leading-tight">Transition to GraphQL with <strong class="text-primary-500">MetricQL</strong> </div>

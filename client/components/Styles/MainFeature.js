                ...
                <div id="TextColumn" className="w-full max-w-md mx-auto md:max-w-none md:mx-0">
                    <div id="TContent" className="md:w-20/5 mt-16 md:mt-0 ">
                        <div id="TContentLeft" className="md:mr-12 lg:mr-16 md:order-first">
                            ...
                            <div id="heading" className="mt-4 font-black text-left text-3xl sm:text-4xl lg:text-5xl text-blue text-center md:text-left leading-tight">Transition to GraphQL with <strong className="text-purple">MetricQL</strong> </div>
                            <p id="Description" className="mt-4 text-center md:text-left text-sm md:text-base lg:text-lg font-medium leading-relaxed text-secondary">We are GraphQL and we do great things!</p>
                        </div>
                    </div>
                </div>

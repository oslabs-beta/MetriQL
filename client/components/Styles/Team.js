        ...
        <div>
            <div class="relative max-w-screen-xl mx-auto py-20 lg:py-24">
                <div class="container flex justify-center mx-auto pt-12">
                    <div>
                        <h5 class="font-bold text-primary-500 flex justify-center">Our Team</h5>
                        <h1 class="text-4xl sm:text-5xl font-black text-blue-800 tracking-wide text-center">Meet the Team</h1>
                    </div>
                </div>
                <div class = "flex flex-wrap flex-row justify-center sm:max-w-2xl lg:max-w-5xl mx-auto">
                    <div class="mt-24 w-full sm:w-1/2 lg:w-1/3 flex flex-col items-center">
                        ...
                        <h3 class="uppercase font-bold tracking-widest text-xs text-primary-500"> Software Engineer </h3>

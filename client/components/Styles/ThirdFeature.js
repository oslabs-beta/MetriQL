...
const SecondFeature = (props) => {
    return (
        <div className='relative'>
            <div className='flex flex-col md:flex-row justify-between max-w-screen-2xl mx-auto py-20 md:py-24 items-center'>
                <div className='w-full max-w-md mx-auto md:max-w-none md:mx-0'>
                    <div className='md:w-9/12 flex-shrink-0 relative'>
                        <div className='lg:py-8 text-center md:text-left'>
                            <div className='font-bold text-purple text-center md:text-left'> Feature 2</div>
                ...
                <div className='md:w-9/12 mt-16 md:mt-0'>
                    <div className='md:mr-12 lg:mr-16 md:order-first'>
                        ...
                        <img src='/demophoto2.png' alt="MetricQLvisualizer" className="w-5000 h-5000 bg-contain bg-center rounded"></img>
